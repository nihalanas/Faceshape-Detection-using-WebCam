...
model.load_state_dict(torch.load('---pathtothefile---/best_model.pth', map_location=device))
model.eval()
...
while True:
    ...
    # Display the frame along with the predicted label
    cv2.putText(frame, f'Predicted Class: {predicted_label}', (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0), 2)
